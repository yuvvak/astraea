...
| UNKNOWN | baseline | fail | product_code is UNKNOWN / not on the MA-eligible product list | Not on the firm's MA-eligible product list - fails closed pending explicit classification |
